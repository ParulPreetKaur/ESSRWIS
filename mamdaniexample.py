...
Plot1=LinguisticVariable([S_1, S_2, S_3], concept='Service quality', universe_of_discourse=[0,10])
Plot1.plot()
...
Plot2=LinguisticVariable([F_1, F_2], concept='Food quality', universe_of_discourse=[0,10])
Plot2.plot()
...
Plot3=LinguisticVariable([T_1, T_2, T_3], universe_of_discourse=[0,25])
Plot3.plot()
